...
int main() {
    ...
    float angle_rad = angle_deg * (b2_pi / 180.0f);

    b2BodyDef groundBodyDef;
    groundBodyDef.position.Set(5.0f, 3.0f);
    b2Body* ground = world.CreateBody(&groundBodyDef);

    b2PolygonShape groundShape;
    groundShape.SetAsBox(10.0f, 0.5f, b2Vec2(0.0f, 0.0f), -angle_rad);
    ...
    leftWallDef.position.Set(0.0f, 10.0f);
    ...
    rightWallDef.position.Set(20.0f, 10.0f);
    ...
    sf::RenderWindow window(sf::VideoMode(SCREEN_WIDTH, SCREEN_HEIGHT), "Caja sobre plano inclinado");
    ...
    sf::RectangleShape groundRect(sf::Vector2f(20.0f * PIXELS_PER_METER, 1.0f * PIXELS_PER_METER));
    groundRect.setFillColor(sf::Color(150, 75, 0));
    groundRect.setOrigin(10.0f * PIXELS_PER_METER, 0.5f * PIXELS_PER_METER);
    groundRect.setPosition(5.0f * PIXELS_PER_METER, SCREEN_HEIGHT - 3.0f * PIXELS_PER_METER);
    groundRect.setRotation(angle_deg);
    ...
    leftWallRect.setPosition(0.0f * PIXELS_PER_METER, SCREEN_HEIGHT - 10.0f * PIXELS_PER_METER);

    sf::RectangleShape rightWallRect = leftWallRect;
    rightWallRect.setPosition(20.0f * PIXELS_PER_METER, SCREEN_HEIGHT - 10.0f * PIXELS_PER_METER);

    sf::RectangleShape floorRect(sf::Vector2f(26.0f * PIXELS_PER_METER, 1.0f * PIXELS_PER_METER));
    floorRect.setFillColor(sf::Color(100, 100, 100));
    floorRect.setOrigin(13.0f * PIXELS_PER_METER, 0.5f * PIXELS_PER_METER);
    floorRect.setPosition(13.0f * PIXELS_PER_METER, SCREEN_HEIGHT - 0.5f * PIXELS_PER_METER);
